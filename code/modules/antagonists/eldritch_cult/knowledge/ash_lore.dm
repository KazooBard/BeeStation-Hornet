...
/datum/eldritch_knowledge/spell/ashen_rewind
	...
	desc = "Lets you rewind back after 15 seconds."
	cost = 1
...
/datum/eldritch_knowledge/spell/executioners_fury
	...
	gain_text = "And he swung, and swung till his son's face was one with the ground below him. He asked, 'son, why do you protect the weak and corroded by sin? What will you have once they all are taken down below'. He remained silent."
	desc = "Empower your action speed for a few seconds, allowing you to attack at a high speed."
	cost = 1
	spell_to_add = (/obj/effect/proc_holder/spell/aimed/firebreath)
	next_knowledge = list(/datum/eldritch_knowledge/ash_mark)
...
/datum/eldritch_knowledge/spell/flame_judgement
	...
	desc = "Short range spell that allows you to curse someone with massive sanity loss."
	cost = 1
	spell_to_add = /obj/effect/proc_holder/spell/targeted/fiery_judgement
	next_knowledge = list(/datum/eldritch_knowledge/armor/ash, /datum/eldritch_knowledge/ash_blade_upgrade)
	route = PATH_ASH
